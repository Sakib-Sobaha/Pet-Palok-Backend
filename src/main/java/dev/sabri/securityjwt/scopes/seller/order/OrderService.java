...
public record OrderService(EmailService emailService) {
    ...
    public void sendAcceptedMail(User user, Optional<Order> order) {
        ...
        String htmlMessage = "<html>"
                ...
                + "<img src=\"" + logoUrl + "\" alt=\"Company Logo\" style=\"display:block; margin: 0 auto; max-width: 200px;\">"
    ...
    public void acceptedConfirmationMail(Seller seller, Optional<Order> order) {
        String subject = "Confirmation Email";
        String name = seller.getName() + ", Store Name : " + seller.getStoreName();
        String orderId = order.get().getId().toString();
        ...
        String htmlMessage = "<html>"
                ...
                + "<div class=\"email-container\">"
                + "<img src=\"" + logoUrl + "\" alt=\"Company Logo\" style=\"display:block; margin: 0 auto; max-width: 200px;\">"
                + "<h2 style=\"color: #fff; font-weight: bold; font-family: 'Cascadia Code'\">Welcome to our Pet-Palok app!  Thank you, " + name +  " for selling!</h2>"
                + "<p style=\"font-size: 24px; color: white; font-weight: bold; font-family: 'Cascadia Code'\">Here is the update of the order made to you:</p>"
                // The animated verification box with white text and red label in square shape
                + "<div class=\"verification-box\">"
                + "<div>"
                + "<h3 class=\"verification-label\">Your have accepted the order. Please follow the website to stay updated and sell more to earn more!</h3>"
                + "<p class=\"verification-code\">" + "Order id: " + orderId + "</p>"
                + "</div>"
                + "</div>"
                // Add the message and GIF below the verification box
                + "<p class=\"pet-message\">We are happy since you love pets!</p>"
    ...
    public void rejectedConfirmationMail(Seller seller, Optional<Order> order) {
        String subject = "Rejection Confirmation Email";
        String name = seller.getName() + ", Store Name : " + seller.getStoreName();
        String orderId = order.get().getId().toString();
        ...
        String htmlMessage = "<html>"
                ...
                + "<div class=\"verification-box\">"
                + "<div>"
                + "<h3 class=\"verification-label\">Your have rejected the order. Please follow the website to stay updated and sell more to earn more!</h3>"
                + "<p class=\"verification-code\">" + "Order id: " + orderId + "</p>"
                + "</div>"
                + "</div>"
                // Add the message and GIF below the verification box
    ...
    public void deliveryConfirmationMail(Seller seller, Optional<Order> order) {
        String subject = "Delivery Confirmation Email";
        String name = seller.getName() + ", Store Name : " + seller.getStoreName();
        String orderId = order.get().getId().toString();
        ...
        String htmlMessage = "<html>"
                ...
                + "<div class=\"email-container\">"
                + "<img src=\"" + logoUrl + "\" alt=\"Company Logo\" style=\"display:block; margin: 0 auto; max-width: 200px;\">"
                + "<h2 style=\"color: #fff; font-weight: bold; font-family: 'Cascadia Code'\">Welcome to our Pet-Palok app!  Thank you, " + name +  " for selling pet items!</h2>"
                + "<p style=\"font-size: 24px; color: white; font-weight: bold; font-family: 'Cascadia Code'\">Here is the update of the order made to you:</p>"
                // The animated verification box with white text and red label in square shape
                + "<div class=\"verification-box\">"
                + "<div>"
                + "<h3 class=\"verification-label\">Your have ensured the order is out for delivery. Please follow the website to stay updated and sell more to earn more!</h3>"
                + "<p class=\"verification-code\">" + "Order id: " + orderId + "</p>"
                + "</div>"
                + "</div>"
                // Add the message and GIF below the verification box
    ...
    public void deliveredConfirmationMail(Seller seller, Optional<Order> order) {
        String subject = "Delivered Confirmation Email";
        String name = seller.getName() + ", Store Name : " + seller.getStoreName();
        String orderId = order.get().getId().toString();
        ...
        String htmlMessage = "<html>"
                ...
                + "<div class=\"verification-box\">"
                + "<div>"
                + "<h3 class=\"verification-label\">Your have delivered the order. Please follow the website to stay updated and sell more to earn more!.</h3>"
                + "<p class=\"verification-code\">" + "Order id: " + orderId + "</p>"
                + "</div>"
                + "</div>"
                // Add the message and GIF below the verification box
