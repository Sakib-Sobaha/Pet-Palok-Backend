...
@Service
public record AppointmentService(EmailService emailService) {

    public void sendAppointmentStatusEmail(User user, Vet vet, Pet pet, Appointment appointment, String update1, String update2) {
        ...
        String htmlMessage = "<html>"
                ...
                + "<h2 style=\"color: #fff; font-weight: bold; font-family: 'Cascadia Code'\">Welcome to our Pet-Palok app!  Thank you, " + userName +  " for making an appointment with" + vetName + "for pet" + petName + "!</h2>"
                + "<p style=\"font-size: 24px; color: white; font-weight: bold; font-family: 'Cascadia Code'\">Here is the Updated Status of your appointment:</p>"
                // The animated verification box with white text and red label in square shape
                + "<div class=\"appointment-box\">"
                + "<div>"
                + "<h3 class=\"appointment-label\">" + update1 + " " + update2 + "Please follow the website to stay updated.</h3>"
                + "<p class=\"appointment-code\">" + "Your appointment id: " + appointmentId + "</p>"
                + "</div>"
                + "</div>"
    ...
    public void sendVetAppointmentStatusEmail(User user, Vet vet, Pet pet, Appointment appointment, String update1, String update2) {
        String subject = "Appointment Status";
        String userName = user.getFirstname() + " " + user.getLastname();
        String vetName = vet.getFirstname() + " " + vet.getLastname();
        String petName = pet.getName();
